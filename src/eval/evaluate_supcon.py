...
def main():
    ...
    backbone = get_model(args.model_name, num_classes=26, pretrained=False)
    model = SupConViT(backbone, backbone_name=args.model_name, num_classes=26)
    ...
    for name, csv_path in test_sets.items():
        ...
        _, _, transform_test = get_transforms(
            backbone, model_name=args.model_name, image_size=224
        )
